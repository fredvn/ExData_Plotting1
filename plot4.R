...
#top right
plot(date_filter$stamp,date_filter$voltage,type="l",ylab="Voltage",xlab="datetime")
...
legend("topright",lty=c(1,1,1),lwd=c(2.5,2.5,2.5),col=c("black","red","blue"), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),bty="n")
	
#bottom right
plot(date_filter$stamp,date_filter$globalreactivepower,type="l",ylab="Global_active_power",xlab="datetime")
